...
import { SidebarInset, useSidebar } from '@/ui/sidebar/sidebar';
import { useGlobalSidebarShortcuts } from '@/features/sidebar/hooks/use-global-sidebar-shortcuts';
import { SearchBar } from '@/features/search/components/search-bar';
import { useEditorRegistry } from '@/core/store/hooks/use-editor-registry';
import { WorkspaceSkeleton } from '@/pages/workspace-skeleton';
import {
  useSyncActiveFileSelection,
  useSyncActiveSpaceSelection,
} from '@/core/store/hooks/use-filesystem-store';
import { useAppSelector } from '@/core/store/hooks';
import { selectActiveSpaceId } from '@/core/store/selectors';
