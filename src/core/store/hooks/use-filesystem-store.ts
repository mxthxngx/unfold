...
import { removeLastOpenedFile } from '@/core/utils/last-opened';
import { Node } from '@/core/types/sidebar';
import {
  findNodeById,
  findNodePath,
  flattenVisibleNodes,
...
import { setActiveFileId, setActiveSpaceId } from '@/core/store/slices/ui-slice';
import {
  useAddNodeMutation,
